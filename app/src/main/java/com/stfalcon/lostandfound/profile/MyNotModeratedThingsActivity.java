...
public class MyNotModeratedThingsActivity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView =inflater.inflate(R.layout.my_not_moderated_things_layout,container,false);

        myListView=(ListView) rootView.findViewById(R.id.my_not_moderated_list);
        listItems=getResources().getStringArray(R.array.not_moderated_list_items);
